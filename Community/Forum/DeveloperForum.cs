...
{
    /// <summary>
    /// Summary description for DeveloperForum
    /// </summary>
    [TestClass]
    public class DeveloperForum : BaseTest
    {
        ...
        public void TestMethod_ForumDeveloper()
        {
            //Read From data sheet
            ReadData();

            _Subject = _Subject + "  Developer";
            ...
            CommonFunctions.ValideActivityStream(myManager, myManager.ActiveBrowser, _Url, _Subject, "DEVELOPER");
        ...
        public void ReadData()
        {
            ...
            _ForumUrl = TestContext.DataRow["ForumUrlDev"].ToString();
        }
