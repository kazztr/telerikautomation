...
{
    /// <summary>
    /// Summary description for TechnicalForum
    /// </summary>
    [TestClass]
    public class TechnicalForum : BaseTest
    {
        ...
        public void TestMethod_ForumTechnical()
        {
            //Read From data sheet
            ReadData();

            _Subject = _Subject + "  Technical";
            ...
            CommonFunctions.ValideActivityStream(myManager, myManager.ActiveBrowser, _Url, _Subject, "TECHNICAL");
        ...
        public void ReadData()
        {
            ...
            _ForumUrl = TestContext.DataRow["ForumUrlTech"].ToString();
        }
